...
function App() {
  ...
  const cars = [
    {id: 1, brand:"Fiat", km:38329, year:2012, color:"Branco", newCar:false },
    {id: 2, brand:"BMW", km:0, year:2025, color:"Ocean Blue", newCar:true },
    {id: 3, brand:"VWM", km:549000, year:2018, color:"preto", newCar:false },
    {id: 4, brand:"Nissan", km:0, year:2023, color:"Branco", newCar:true },
    {id: 5, brand:"Hyundai", km:259, year:2024, color:"preto", newCar:false }
  ...
  const users = [
    {id:1, name:"VIncius", idade:21, job:"programador"},
